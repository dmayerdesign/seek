	...
	return (
		<section style={{ padding: "0" }}>
							...
							<div>
								{responseAlreadySubmitted.response_image_base64 ? (
									<div style={{ width: "100%", background: "#fff" }}>
										<img
											src={responseAlreadySubmitted.response_image_base64}
											style={{ width: "100%" }}
										/>
									</div>
									...
									<div style={{ width: "100%", background: "#fff" }}>
										<img
											src={responseAlreadySubmitted.response_image_url}
											style={{ width: "100%" }}
										/>
									</div>
								) : (
			...
			<div style={{ maxWidth: "1000px", marginTop: "25px" }}>
				...
				>
					{!submitting && !submitted ? "Submit" : !submitted ? "Submitting..." : "Submitted!"}
				</button>
			</div>
		</section>
	)
