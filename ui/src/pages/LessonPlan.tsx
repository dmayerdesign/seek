					...
					if (teacherData && oldLessonQuestion && !isEqual(oldLessonQuestion, lessonQuestionInput)) {
						...
						const newLessonPlans = teacherData.lesson_plans?.map((lp) =>
							lp.id == lessonPlanId
								? {
										...lp,
										questions: lp.questions.map((lq) =>
											lq.id === lessonQuestionId
												? {
														...lq,
														...lessonQuestionInput,
														media_content_urls: [
		...
		<div className="light">
			<div className="seek-page">
				<div className="page-content">
					{!lessonPlan || !lessonPlanCtrl || !teacherData ? (
						<div>
								...
								<div className="content-gutters">
									...
									<div key={lessonPlan.id}>
										...
										>
											...
											/>
											{!teacherData.lessons?.find((l) => l.lesson_plan_id === lessonPlan.id) && (
												<button
													onClick={() => {
														if (
															window.confirm(
																`Are you sure you want to delete ${lessonPlan.title}?`,
															)
														) {
														...
														i === 0 ? "Pre-conception question" : i === 1 ? "Post-conception question" : "Question " + (i + 1)
															...
															>
																...
																{!teacherData.lessons?.find(
																	(l) => l.lesson_plan_id === lessonPlan.id,
																) && (
																	<button
																		onClick={() => {
																			if (
															...
															<div>
																<p>
																	Optionally, enter below one or more categories of
																	response that you expect to see, separated by
																	commas. Otherwise, the app will make its best effort
																	to categorize reasonably.
																</p>
																<br />
																<textarea
																	placeholder={
																...
																<div>
																	...
																	>
																		...
																		>
																				...
																				<input
																					...
																					onChange={(e) => {
																						...
																						if (
																							...
																							uploadFile(
																								file,
																								`${teacherData.id}/media-for-questions`,
																							).then((url) => {
																								const newLessonQuestion: LessonQuestion =
																									{
																										...lessonQuestionsCtrl[
																			...
																			<p style={{ margin: "10px" }}>
																				<small>
																					Use JPEG or PNG files for the best
																					results
																				</small>
																			</p>
																		</div>
																	...
																	>
																		<div style={{ flexGrow: 1 }}>
																			...
																			>
																				...
																				model&rsquo;s analysis
																			</h5>
																			<p>
																				e.g. textbook materials, categorization
																				guidance
																			</p>
																			<ul className="file-list">
																		...
																		>
																				...
																				<input
																					...
																					onChange={(e) => {
																						...
																						if (
																							...
																							uploadFile(
																								file,
																								`${teacherData.id}/context-materials`,
																							).then((url) => {
																								const newLessonQuestion: LessonQuestion =
																									{
																										...lessonQuestionsCtrl[
																			...
																			<p style={{ margin: "10px" }}>
																				<small>
																					Must be a PDF or image file, smaller
																					than 5 MB
																				</small>
																			</p>
																		</div>
